...
<body> 
    <main>
        <div class="hero full-height jarallax" data-jarallax data-speed="0.2">
            <img class="jarallax-img kenburns" src="/frontend/asset/img/rooms/1.jpg" alt="">
            ...
            <div class="container-fluid p-lg-0">
                <div data-cues="zoomIn">
                    <div class="owl-carousel owl-theme carousel_item_centered kenburns rounded-img">
                        <div class="item">
                            <img src="/frontend/asset/img/rooms/opt_5.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="/frontend/asset/img/rooms/opt_1.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="/frontend/asset/img/rooms/opt_4.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="/frontend/asset/img/rooms/opt_6.jpg" alt="">
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-7 order-lg-1">
                    ...
                    <div class="review_card">
                        <div class="row">
                            <div class="col-md-2 user_info">
                                <figure><img src="/frontend/asset/img/avatar6.jpg" alt=""></figure>
                                <h5>Lukas</h5>
                            </div>
                            <div class="col-md-10 review_content">
                                <div class="clearfix mb-3">
                    ...
                    <div class="review_card">
                        <div class="row">
                            <div class="col-md-2 user_info">
                                <figure><img src="/frontend/asset/img/avatar1.jpg" alt=""></figure>
                                <h5>Marika</h5>
                            </div>
                            <div class="col-md-10 review_content">
                                <div class="clearfix mb-3">
                        ...
                        <div class="row reply">
                            <div class="col-md-2 user_info">
                                <figure><img src="/frontend/asset/img/avatar.jpg" alt=""></figure>
                            </div>
                            <div class="col-md-10">
