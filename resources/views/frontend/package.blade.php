...
<head>
    ...
    <link rel="apple-touch-icon" type="image/x-icon" href="/frontend/asset/img/apple-touch-icon-57x57-precomposed.png">
    ...
    <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="i/frontend/asset/mg/apple-touch-icon-144x144-precomposed.png">
    ...
    <!-- SPECIFIC CSS -->
    <link href="/frontend/asset/css/day_menu.css" rel="stylesheet">
...
<body>
    ...
    <section class="menu-section">
        <div class="full-container">
            <div class="intro p-3"><img src="/frontend/asset/img/logo.png" width="135" height="45" alt="" class="mb-3"><br>Menu of the Day<span>Maiores eos labore ratione illum excepturi neque</span></div>
        </div>
   ...
   <section class="menu-section">
    ...
    <nav>
        <ul class="top-nav">
            <li><a href="{{url('master')}}" class="back"><i class="bi bi-arrow-90deg-left"></i></a></li>
        </ul>
    </nav> <!-- End top-nav-->
    ...
    <!-- Specific scripts -->
    <script src="/frontend/asset/js/day_menu.js"></script>
