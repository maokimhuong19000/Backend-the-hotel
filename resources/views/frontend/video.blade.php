        ...
        <div class="hero medium-height jarallax" data-jarallax data-speed="0.2">
            ...
            <div class="wrapper opacity-mask d-flex align-items-center justify-content-center text-center animate_hero" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                <div class="container">
                    ...
                    <h1 class="slide-animated two">FOOTAGES</h1>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="item col-xl-4 col-lg-6 col-mb-6 mb-4">
                        <div class="item-img" data-cue="slideInUp">
                            ...
                            <div class="content">
                                <a  data-fslightbox="gallery_1" data-type="image" href="/frontend/asset/img/gallery/2.jpg"><i class="bi bi-arrows-angle-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="item col-xl-4 col-lg-6 col-mb-6 mb-4">
                    ...
                    <div class="item col-xl-4 col-lg-6 col-mb-6 mb-4">
                       <div class="item-img" data-cue="slideInUp">
                            ...
                            <div class="content">
                                <a  data-fslightbox="gallery_1" data-type="image" href="i/frontend/asset/mg/gallery/5.jpg"><i class="bi bi-arrows-angle-expand"></i></a>
                            </div>
                        </div>
                    </div>
