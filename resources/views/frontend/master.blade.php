...
<body>
    <main>
        <div class="hero home-search full-height jarallax"
            data-jarallax-video="mp4:./frontend/asset/video/sunset.mp4,webm:./frontend/asset/video/sunset.webm,ogv:./frontend/asset/video/sunset.ogv"
            data-speed="0.2">
                            ...
                            {{-- <div class="row g-0 booking_form">
                                <div class="col-lg-4 ">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="dates" id="dates"
                                            placeholder="Check in / Check out" readonly="readonly">
                                ...
                                <div class="col-lg-3 col-sm-6 ps-lg-0 ps-sm-1">
                                    <div class="qty-buttons">
                                        ...
                                        <input type="text" name="childs" id="childs" value=""
                                            class="qty form-control">
                ...
                <div class="row justify-content-between flex-lg-row-reverse align-items-center">
                    <div class="col-lg-5">
                        <div class="parallax_wrapper">
                            <img src="/frontend/asset/img/home_2.jpg" alt="" class="img-fluid rounded-img">
                            <div data-cue="slideInUp" class="img_over"><span data-jarallax-element="-30"><img
                                        src="/frontend/asset/img/home_1.jpg" alt="" class="rounded-img"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="intro">
                            ...
                            <p class="lead">Vivamus volutpat eros pulvinar velit laoreet, sit amet egestas erat
                                dignissim.</p>
            ...
            <div class="pinned-image pinned-image--medium">
                <div class="pinned-image__container" id="section_video">
                    <video loop="loop" muted="muted" id="video_home">
                        <source src="/frontend/asset/video/swimming_pool_2.mp4" type="video/mp4">
                        <source src="/frontend/asset/video/swimming_pool_2.webm" type="video/webm">
                        <source src="/frontend/asset/video/swimming_pool_2.ogv" type="video/ogg">
                    </video>
        ...
        <div class="container margin_120_95">
            ...
            <div class="row justify-content-center add_bottom_90" data-cues="slideInUp" data-delay="300">
                <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
                    <a href="/roomdetails" class="box_cat_rooms">
                        @foreach ($getData->where('room_id', 1) as $item)
                        <figure>
                            <div class="background-image" data-background="url({{$item->room_img}})">
                            </div>
                            <div class="info">
                                {{-- <input type="text" value="{{$item->room_id}}"> --}}
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <a href="/roomdetails" class="box_cat_rooms">
                        @foreach ($getData->where('room_id', 2) as $item)
                        <figure>
                            <div class="background-image" data-background="url({{$item->room_img}})">
                            </div>
                            <<div class="info">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <a href="/roomdetails" class="box_cat_rooms">
                        @foreach ($getData->where('room_id', 3) as $item)
                        <figure>
                            <div class="background-image" data-background="url({{$item->room_img}})">
                            </div>
                            <div class="info">
                ...
                <p class="text-end"><a href="http://127.0.0.1:8000/roomlist1" class="btn_1 outline mt-2">View all Rooms</a></p>
            </div>
            <!-- /row-->
        ...
        <div class="marquee">
            <div class="track">
                <div class="content">&nbsp;Relax Enjoy Luxury Holiday Travel Discover Experience Relax Enjoy Luxury
                    Holiday Travel Discover Experience Relax Enjoy Luxury Holiday Travel Discover Experience Relax Enjoy
                    Luxury Holiday Travel Discover Experience</div>
            </div>
        </div>
        <!-- /marquee-->
            ...
            <div class="container margin_120_95">
                    ...
                    <div class="col-lg-6">
                        <div class="pinned-image rounded_container pinned-image--small mb-4">
                            <div class="pinned-image__container">
                                <img src="/frontend/asset/img/local_amenities_1.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                ...
                <div class="row justify-content-between d-flex align-items-center">
                    <div class="col-lg-6 order-lg-2">
                        <div class="pinned-image rounded_container pinned-image--small mb-4">
                            <div class="pinned-image__container">
                                <img src="/frontend/asset/img/local_amenities_3.jpg" alt="">
                            </div>
                        </div>
                    </div>
        ...
        <div class="parallax_section_1 jarallax" data-jarallax data-speed="0.2">
            <img class="jarallax-img kenburns-2" src="/frontend/asset/img/hero_home_1.jpg" alt="">
                            ...
                            <div class="carousel_testimonials owl-carousel owl-theme nav-dots-orizontal">
                                <div>
                                    <div class="box_overlay">
                                        <div class="pic">
                                            <figure><img src="/frontend/asset/img/testimonial_1.jpg" alt=""
                                                    class="img-circle">
                                            </figure>
                ...
                <div class="row justify-content-center home">
                    <div class="item col-xl-4 col-lg-6">
                        <a href="news-post.html" class="box_contents" data-cue="slideInUp" data-delay="300">
                            <figure><img src="/frontend/asset/img/blog-1.jpg" alt="" class="img-fluid"><em>11
                                    Dec</em>
                            </figure>
                            <div class="wrapper">
                    ...
                    <div class="item col-xl-4 col-lg-6">
                        <a href="news-post.html" class="box_contents" data-cue="slideInUp" data-delay="400">
                            <figure><img src="/frontend/asset/img/blog-3.jpg" alt="" class="img-fluid"><em>24
                                    Dec</em>
                            </figure>
                            <div class="wrapper">
                    ...
                    <div class="item col-xl-4 col-lg-6">
                        <a href="news-post.html" class="box_contents" data-cue="slideInUp" data-delay="500">
                            <figure><img src="/frontend/asset/img/blog-2.jpg" alt="" class="img-fluid"><em>21
                                    Dec</em>
                            </figure>
                            <div class="wrapper">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-xl-7">
                    <div data-cue="slideInUp" data-delay="200">
                        ...
                        <!-- / row -->
                        <p class="text-end mt-4"><a href="#myModal" data-bs-toggle="modal"
                                class="btn_1 outline">Now</a></p>
                    </div>
                </div>
                <!-- /col -->
            </div>
