! function(t, e) {
    ...
    return function(t) {
        ...
        e.initTitle = function(t) {
            if (t) {
                r.injectElIntoModal(o.titleMarkup).textContent = t
            }
        }, e.initText = function(t) {
            if (t) {
                r.injectElIntoModal(o.textMarkup).textContent = t
            }
        }
    }, function(t, e, n) {
        "use strict";
        ...
        var o = n(5),
            ...
            O = function(t) {
                o.default.timer && clearTimeout(o.default.timer), t && (o.default.timer = setTimeout(function() {
                    return r.onAction(i.CANCEL_KEY)
                }, t))
            },
            _ = function(t) {
